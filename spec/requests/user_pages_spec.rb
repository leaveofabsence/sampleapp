...
describe 'UserPages' do
  ...
  describe 'index' do
    ...
    describe 'delete links' do
      ...
      describe 'as non-admin user' do
        ...
        specify {user.should respond_to(:admin?)}
        specify {non_admin.admin?.should be_false}
  ...
  describe 'signup page' do
    ...
    describe 'for signed-in user' do
      ...
      it 'should not allow access to signup_path' do
        get signup_path
        expect {response}.should redirect_to(root_path)
      end

      it 'should not allow a user to be created' do
        post users_path
        expect {response}.should redirect_to(root_path)
      end
    end
  ...
  describe 'signup page' do
    ...
    describe 'with valid information' do
      before do
        fill_in 'Name', with: 'Joe Horton'
        fill_in 'Email', with: 'joe@horton.com'
